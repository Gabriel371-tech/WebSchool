package br.com.webschool.service;

import br.com.webschool.entity.Aluno;
...
public class RelatorioService {
    ...
    private void generatePdf(HttpServletResponse response, List<Aluno> alunos, String title) throws IOException {
        ...
        writer.setPageEvent(new PdfPageEventHelper() {
            ...
            public void onEndPage(PdfWriter writer, Document document) {
                ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER,
                        new Phrase("Página " + writer.getPageNumber() + " - Faculdade WebSchool", FontFactory.getFont(FontFactory.HELVETICA, 8)),
        ...
        Paragraph headerInfo = new Paragraph("Faculdade WebSchool - Sistema de Gestão Acadêmica", fontHeader);
